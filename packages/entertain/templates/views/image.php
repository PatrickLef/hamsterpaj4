<div class="entertain_div">
	...
	<div class="content">
	<a href="/<?php echo $item->category; ?>/slumpad">
		<img src="http://static.hamsterpaj.net/entertain/images/<?php echo $item->get('handle'); ?>.jpg" style="width: <?php echo $imagewidth; ?>px;" />
	</a>
	</div>
	<div class="info">
		<div class="extrainfo">
